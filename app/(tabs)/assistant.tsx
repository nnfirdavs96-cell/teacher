...
const SUGGESTIONS = [
  ...
  'Картинка рассыпается на квадратики',
  'Wi-Fi плохо ловит в дальней комнате',
  'Горит красная лампочка на роутере с оптикой',
  'Как самому навести тарелку?',
];
        ...
        {showSettings && (
          <View style={{ paddingHorizontal: spacing.lg }}>
            <View style={settingsCard}>
              <H3>Настройки</H3>
              <Small>
                Чтобы ИИ отвечал, нужен ключ доступа (API-ключ Anthropic). Получить за пару минут:
                зайдите на console.anthropic.com → Sign up → раздел API Keys → Create Key →
                скопируйте строку, начинающуюся с «sk-ant-», и вставьте ниже. Ключ хранится только
                на этом устройстве и никуда не передаётся, кроме сервиса ответов.
              </Small>
